...
const CryptoDetails = () => {
  ...
  const { data, isLoading, error } = useGetCryptosDetailQuery(coinId);
  ...
  useEffect(() => {
    setcryptoDetails(data && data?.data?.coin);
  }, [data]);
  ...
  return (
    <Col className="coin-detail-container">
      ...
      <Select
        ...
        palceholder="select Time period"
        onChange={(value) => settime(value)}
      >
        {time_period.map((time_p) => (
          <Option key={time_p}> {time_p}</Option>
        ))}
      </Select>
